...
if (strpos($url,'id') !== false) {
   ...
   if(isset($_POST['submit']))
         ...
         $stmt = $pdo->prepare('UPDATE `paramin` SET `members_read`=?,`members_write`=?,`members_payement_schedule_read`=?,`members_products_read`=?,`members_schedules_red`=?,`members_add`=?,`payement_schedules_need`=?,`payement_schedules_write`=?,`members_statistics_read`=?,`payement_day_read`=? WHERE partenaire=?');
         ...
         $subject = "Un changement à était effectué !";
                ...
                <div class="bg-black">
                  <div class="container">
                    ...
                    <p class="ax-center max-w-96 lh-lg text-white text-center text-2xl mb-10">
                      Il y a eu du changements sur votre compte, connectez vous pour le découvrir !
                    </p>
                    <center><a class="btn btn-primary p-3 fw-700" href="https://app.bootstrapemail.com/templates">Connectez vous</a></center>
                  </div>
                </div>
              </body>
              </html>'; 
                ...
                <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start mb-5">
                    <div class="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block mb-3 bs-icon md"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bell">
                        ...
                        <div>
                            <h4>Membres Read</h4>
                            <label class="switch">
                                <input type="checkbox" name="choice1" <?php if ($min['members_read']==1){echo "checked='checked'";} ?> <?php if ($min['members_read']==1){echo "disabled";} ?>>
        ...
        <form  method="post">
                <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start mb-5">
                    ...
                    <div>
                        <h4>Members Write</h4>
                        <label class="switch">
                            <input type="checkbox" name="choice2" <?php if ($min['members_write']==1){echo "checked='checked'";} ?> <?php if ($min['members_write']==1){echo "disabled";} ?>>
                            <span class="slider round"></span>
                            </label>
                    </div>
                </div>
                ...
                <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start">
                    ...
                    <div>
                        ...
                        <label class="switch">
                            <input type="checkbox" name="choice3" <?php if ($min['members_payement_schedule_read']==1){echo "checked='checked'";} ?> <?php if ($min['members_payement_schedule_read']==1){echo "disabled";} ?>>
                            <span class="slider round"></span>
                            </label>
                    </div>
                </div>
               ...
               <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start mb-5">
                <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start">
                    ...
                    <div>
                        ...
                        <label class="switch">
                            <input type="checkbox" name="choice4" <?php if ($min['members_statistics_read']==1){echo "checked='checked'";} ?> <?php if ($min['members_statistics_read']==1){echo "disabled";} ?>>
                            <span class="slider round"></span>
                            </label>
                    </div>
                </div>
               ...
               <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start mb-5">
                <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start">
                    ...
                    <div>
                        ...
                        <label class="switch">
                            <input type="checkbox" name="choice5" <?php if ($min['members_day_read']==1){echo "checked='checked'";} ?> <?php if ($min['members_day_read']==1){echo "disabled";} ?>>
                            <span class="slider round"></span>
                            </label>
                    </div>
                </div>
            ...
            <div class="col d-flex flex-column justify-content-center p-4">
                <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start mb-5">
                    ...
                    <div>
                        ...
                        <label class="switch">
                            <input type="checkbox" name="choice6" <?php if ($min['members_products_read']==1){echo "checked='checked'";} ?> <?php if ($min['members_products_read']==1){echo "disabled";} ?>>
                            <span class="slider round"></span>
                            </label>
                    </div>
                </div>
                <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start mb-5">
                    ...
                    <div>
                        ...
                        <label class="switch">
                            <input type="checkbox" name="choice7" <?php if ($min['members_schedules_red']==1){echo "checked='checked'";} ?> <?php if ($min['members_schedules_red']==1){echo "disabled";} ?>>
                            <span class="slider round"></span>
                            </label>
                    </div>
                </div>
               <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start mb-5">
                <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start">
                    ...
                    <div>
                        <h4>Members Add</h4>
                        <label class="switch">
                            <input type="checkbox" name="choice8" <?php if ($min['members_add']==1){echo "checked='checked'";} ?> <?php if ($min['members_add']==1){echo "disabled";} ?>>
                            <span class="slider round"></span>
                            </label>
                    </div>
                </div>
               ...
               <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start mb-5">
                <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start">
                    ...
                    <div>
                        ...
                        <label class="switch">
                            <input type="checkbox" name="choice9" <?php if ($min['members_schedules_need']==1){echo "checked='checked'";} ?> <?php if ($min['members_schedules_need']==1){echo "disabled";} ?>>
                            <span class="slider round"></span>
                            </label>
                    </div>
                </div>
               ...
               <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start mb-5">
                <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start">
                    ...
                    <div>
                        ...
                        <label class="switch">
                            <input type="checkbox" name="choice10" <?php if ($min['members_schedules_write']==1){echo "checked='checked'";} ?> <?php if ($min['members_schedules_write']==1){echo "disabled";} ?> >
                            <span class="slider round"></span>
                            </label>
                    </div>
                </div>
