...
$collections_link = url('index.php?page=collections');
...
$admin_link = isset($_SESSION['account_loggedin']) && $_SESSION['account_admin'] ? '<a href="' . base_url . 'admin.php" target="_blank">Admin</a>' : '';
$partenaire_link = isset($_SESSION['account_loggedin']) && $_SESSION['account_partenaire'] && $_SESSION['isActive'] ? '<a href="' . base_url . 'partenaire.php" target="_blank">Partenaire</a>' : '';
$site_name = site_name;
$base_url = base_url;
echo <<<EOT
<!DOCTYPE html>
	...
	<body>
        <header>
            <div class="content-wrapper">
                <h1>$site_name</h1>
                <nav>
                    <a href="$home_link" title="Stay Around The World">Home</a>
                    <a href="$collections_link">Collections</a>
