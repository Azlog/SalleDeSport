...
searchBar.addEventListener('keyup', (e) => {
    ...
    const filteredCharacters = hpCharacters.filter((character) => {
        return (
            character.adresse.toLowerCase().includes(searchString) ||
            character.telephone.toLowerCase().includes(searchString)||
...
const loadCharacters = async () => {
    try {
        const res = await fetch('https://sportingclubdemarly.fr/admin/recherche_utilisateur.php');
        ...
        .map((character) => {
            ...
            <div class="row row-cols-1 row-cols-md-2">
                <div class="col d-flex flex-column justify-content-center p-2">
                    ...
                    <div class="col-md-12 mt-5"><button class="btn btn-secondary" onclick="location.href = 'structure.php?id=${character.id}'" style="width: 13rem; color: white"><h5 class="d-inline" style="color: white"><strong>Gerer les permissions</strong></h5></button></div>
