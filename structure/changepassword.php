...
if ($_SESSION['account_structure']=="1"){
   ...
   if (isset($_POST['submit'],$_POST['password']))
   {
       ...
       $stmt= $pdo->prepare("UPDATE comptes SET password='$password', firstco=1 WHERE cemail = '$id'");
                            ...
                            <div class="card mb-5">
                                <div class="card-body d-flex flex-column align-items-center">
                                    ...
                                    <form class="text-center" action=""  method="post">
                                        <div class="mb-3"><input class="form-control" type="password" name="password" required="required" placeholder="password"></div>
